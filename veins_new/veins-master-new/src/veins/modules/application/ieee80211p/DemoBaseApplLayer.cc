...
void DemoBaseApplLayer::initialize(int stage)
{
    ...
    if (stage == 0) {
     ...
     //   EV << "Init DempBaseApp Node " << getId() << endl ;
...
// I WANT TO Add a the vehicle ID and send it with sendDown(bsm)
...
void DemoBaseApplLayer::handleSelfMsg(cMessage* msg)
{
    ...
    case SEND_BEACON_EVT: {
        DemoSafetyMessage* bsm = new DemoSafetyMessage("Hello",0);

        // Send vehicle ID here
       // bsm->setAdditionalData('1');
